          ...
          <PopoverContent>
            <div className={style.pop_window}>
              <div className={style.pop_header}>
                <Image src='/favicon.ico' alt='' width={36} height={36} />
                <div>
              ...
              <div className={style.quick_link}>
                <div>
                  <Link
                    isExternal
                    href='https://mjc.ac.kr/mjcIntro.do'
                    color='foreground'
                    underline='hover'
                  >
                    대학안내
                ...
                <div>
                  <Link
                    isExternal
                    href='https://cyber.mjc.ac.kr/index.jsp'
                    color='foreground'
                    underline='hover'
                  >
                    E-Class
                ...
                <div>
                  <Link
                    isExternal
                    href='https://icampus.mjc.ac.kr/mjc/sysUser/doView.do'
                    color='foreground'
                    underline='hover'
                  >
                    I-Campus
                ...
                <div>
                  <Link
                    isExternal
                    href='https://ncsi.mjc.ac.kr/index.do'
                    color='foreground'
                    underline='hover'
                  >
                    역량기반 학사시스템
          ...
          <ModalContent>
            ...
            <ModalBody>
              <div className={style.modal_contents}>
                ...
                >
                  <SelectItem key={'system'}>시스템 설정</SelectItem>
                  <SelectItem key={'light'}>라이트모드</SelectItem>
                  <SelectItem key={'dark'}>다크모드</SelectItem>
                </Select>
              </div>
              <div className={style.modal_contents}>
                <div>
      ...
      {!hasConversation && (
        <div className={style.chat_quick}>
          ...
          <div className={style.quick_cards}>
            <Card className={style.card} shadow='none' isHoverable isPressable>
              <CardBody>
                <p>오늘 학식 메뉴가 뭐야?</p>
              </CardBody>
            </Card>
